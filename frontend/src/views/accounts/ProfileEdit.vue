...
export default {
  ...
  methods: {
    ...
    imageUpload: function () {
      ...
      axios({
        method: "post",
        url: `${process.env.VUE_APP_SERVER_URL}user/upload/${this.userno}`,
    ...
    userEdit: function () {
      ...
      axios({
        method: "post",
        url: `${process.env.VUE_APP_SERVER_URL}user/${this.userno}/`,
        headers: this.setToken(),
        data: this.user,
      })
        .then((res) => {
    ...
    getUserInformationByAdmin: function (user_no) {
      axios({
        method: "get",
        url: `${process.env.VUE_APP_SERVER_URL}admin/${user_no}`,
      })
        .then((res) => {
          console.log(res);
