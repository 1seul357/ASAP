<template>
  <div class="container">
    ...
    <b-form>
      ...
      <b-form-group id="input-title-group" lebel-for="input-title">
      ...
      <b-form-group id="input-description-group" lebel-for="input-description">
        <label class="float-left" for="input-description">스터디 설명</label>
        <b-form-textarea
      ...
      <b-form-group id="input-git-group" label-for="input-git">
        <label class="float-left" for="input-description">스터디 Git</label>
        <b-form-input
          id="input-git"
          v-model="git"
          type="text"
      ...
      <b-form-group id="input-call-group" label-for="input-call">
        <label class="float-left" for="input-description">스터디 연락처</label>
        <b-form-input
          id="input-call"
          v-model="call"
          type="text"
      ...
      <div class="mt-3">
        <b-button @click="updateStudyRoom" class="float-right"
          >수정하기</b-button
        >
      </div>
    </b-form>
